...
class OnbordingFBSetUp extends GetView<OnbordingFBSetUpController> {
  const OnbordingFBSetUp({Key? key}) : super(key: key);
            ...
            Expanded(
              child: Stack(
                children: [
                  ...
                  Obx(() => controller.isFirst.value || controller.islast.value
                      ? Positioned(
                          bottom: 40.h,
                          right: 90.w,
                          child: SizedBox(
                            ...
                            child: CustomRoundedButton(
                              ...
                              backgroundColor:
                                  controller.genderSelected.value == null
                                      ? ColorsUtils.GRAY
                                      : ColorsUtils.PRIMARY,
                              pressed: (() {
